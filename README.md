...
![BWAI Hilarious](https://github.com/user-attachments/assets/d51b500b-e592-4852-850e-27508ce5693c)
...
- [ ] Introduction to Stitch: Deploy with Google AI Studio. In this session, you will get a hands-on introduction to Stitch and learn how to deploy AI-powered applications using Google AI Studio. Whether you're just getting started with AI or already building, this session will walk you through practical workflows to take your ideas from development to deployment. This will be held in the Main Computer Lab,Kabale University on Wednesday 15th April 2026 at 06:00 PM EAT. Register here:( https://gdg.community.dev/events/details/google-gdg-on-campus-makerere-university-kampala-uganda-presents-introduction-to-stitch-deploy-with-google-ai-studio/ )
...
- [ ] Join for the International Women's Day 2026 celebration, themed 'Break the Pattern'. Co-hosted by the Women Techmakers Kampala, this event aims to celebrate the contributions of women in technology and promote conversations around gender equity. We will explore the challenges women face in tech industries and discuss strategies to break traditional patterns that limit progress. 
...
<img width="800" height="800" alt="WhatsApp Image 2026-05-02 at 8 59 58 AM" src="https://github.com/user-attachments/assets/25d753bb-aa9e-4f26-b35f-5732a5b6465e" />
...
- [ ] GDG On Campus Makerere University is partnering with AirQo to host a hands-on workshop focused on building air quality visualization tools using real-time data. This session is designed to move beyond theory into practical, meaningful building.Participants will: Work with live air quality data from the AirQo API,Build interactive pollution maps using Google Maps Platform,Develop projects with real environmental and community impact,Gain hands-on experience integrating real-world APIs. This is an opportunity to build something that directly relates to challenges in Kampala. This will be held on Wednesday, 6th May 2026 at 8:00 AM EAT in the Conference Room Block, A Level 4, COCIS, Makerere University. Register here: ( https://gdg.community.dev/e/mwtaty/)
<img width="1600" height="1600" alt="WhatsApp Image 2026-05-03 at 3 51 54 PM" src="https://github.com/user-attachments/assets/712b280b-b0e2-4a7e-9f0f-edc8b93dd477" />
...
<img width="1080" height="1080" alt="WhatsApp Image 2026-05-05 at 3 29 57 PM" src="https://github.com/user-attachments/assets/f0627725-57c1-4451-824f-580c3819c725" />
...
- [ ] Building AI agents? Come learn how to design powerful, reliable skills, from structuring prompts and tool definitions to connecting with real-world APIs like SMS, Voice & Payments. This will happen on Thursday 7th May, 2026 starting at 05:00PM  and it will be held at The Acacia Place, 4th Floor, John Babiha (Acacia) Avenue, Kampala. Register here: ( https://community.africastalking.com/e/mvjbbk/ )
...
- [ ] AgentCamp Mbarara is a community driven AI learning experience where developers and AI enthusiasts come together to explore the latest in AI agents, tools, and practical applications. Our goal is to help everyone learn, share knowledge, and build real world solutions with AI.
